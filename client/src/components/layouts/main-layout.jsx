          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/blog">
                    <span className="text-gray-600 hover:text-primary">Blog</span>
                  </Link>
                </li>
                <li>
                  <span className="text-gray-600 hover:text-primary">Events</span>
                </li>
                <li>
                  <span className="text-gray-600 hover:text-primary">Tutorials</span>
                </li>
                <li>
                  <span className="text-gray-600 hover:text-primary">Job Board</span>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <span className="text-gray-600 hover:text-primary">Team</span>
                </li>
                <li>
                  <span className="text-gray-600 hover:text-primary">Contribute</span>
                </li>
                <li>
